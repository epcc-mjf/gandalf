...
class Sph : public Hydrodynamics<ndim>
{
 ...
 public:
  ...
  //-----------------------------------------------------------------------------------------------
  virtual int ComputeHNonArray(SphParticle<ndim> &, FLOAT, const NeighbourList<DensityParticle> &,
                       Nbody<ndim> *) = 0;
  virtual int ComputeH(SphParticle<ndim>*, const int, const FLOAT, const FLOAT,
		       NeighbourManager<ndim,DensityParticle>&, Nbody<ndim> *) = 0;
...
public:
 ...
 //public:
  ...
  virtual int ComputeHNonArray(SphParticle<ndim> &, FLOAT, const NeighbourList<DensityParticle> &, Nbody<ndim> *);
  virtual int ComputeH(SphParticle<ndim>*, const int, const FLOAT, const FLOAT,
		       NeighbourManager<ndim,DensityParticle>&, Nbody<ndim> *);
