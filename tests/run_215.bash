...
(
    ...
    # nodes.
    git_copy status -uno &> git_status
    mpirun -n 1 -gtool "amplxe-cl -collect uarch-exploration -knob collect-memory-bandwidth=true -data-limit=0 -result-dir /home/dc-fili1/gandalf/intel/amplxe/projects/gandalf/$input.$sequence.uarch-exploration:0" /home/dc-fili1/gandalf/bin/$suffix/gandalf_measure ../DiRAC/$input.dat &> output
)
