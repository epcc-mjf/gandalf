...
(
    ...
    mpirun -n 1 -gtool "amplxe-cl -collect memory-access -knob analyze-mem-objects=true -knob mem-object-size-min-thres=64 -data-limit=0 -result-dir /home/dc-fili1/gandalf/intel/amplxe/projects/gandalf/$input.$sequence.memory-access:0" /home/dc-fili1/gandalf/bin/gandalf_measure ../DiRAC/$input.dat &> output
)
