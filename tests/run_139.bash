...
#    git status -u no &> git_status
    # This does not give a proper top-down analysis:  mpirun -n 1 -gtool "amplxe-cl -collect hotspots -knob sampling-mode=hw -knob sampling-interval=5 -knob enable-stack-collection=true -data-limit=0 -result-dir /home/dc-fili1/gandalf/intel/amplxe/projects/gandalf/$input.$sequence.hotspots-hw:0" /home/dc-fili1/gandalf/bin/gandalf_measure.$suffix ../DiRAC/$input.dat &> output
    mpirun -n 1 -gtool "amplxe-cl -collect hotspots -knob sampling-interval=5 -knob enable-stack-collection=true -data-limit=0 -result-dir /home/dc-fili1/gandalf/intel/amplxe/projects/gandalf/$input.$sequence.hotspots:0" /home/dc-fili1/gandalf/bin/gandalf_measure.$suffix ../DiRAC/$input.dat &> output
...
input=disc_short_10
suffix=DiRAC_RSE-remove_divides
sequence=139.$suffix
rm -rf $input.$sequence
mkdir $input.$sequence
(
