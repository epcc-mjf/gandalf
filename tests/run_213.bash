...
echo 'why is this echo now needed to get the job to run?'

input=disc_short_128
suffix=DiRAC_RSE-cache_group_together_prefetch_emplace_back
sequence=213.$suffix
...
(
    ...
    mpirun -n 1 -gtool "amplxe-cl -collect hotspots -knob enable-stack-collection=true -data-limit=0 -result-dir /home/dc-fili1/gandalf/intel/amplxe/projects/gandalf/$input.$sequence.hotspots:0" /home/dc-fili1/gandalf/bin/$suffix/gandalf_measure ../DiRAC/$input.dat &> output
)
