...
# 10 minutes after the maximum wall clock time in the .dat file.  One
# time-step for disc_short_2048 on a single core takes about 35 s on
# average; there is a lot of variation.
