...
input=disc_short_128_1048576_8
suffix=DiRAC_RSE-cache_group_together_prefetch_print_pic_distribution
sequence=202.$suffix
...
(
    ...
    # gandalf_plain, not gandalf_plain.$suffix, since I am forgetting to do the copy.
    mpirun -n 2 /home/dc-fili1/gandalf/bin/$gandalf_program ../DiRAC/$input.dat &> output
)

input=GI_disc_short_128_1048576_8
suffix=DiRAC_RSE-cache_group_together_prefetch_print_pic_distribution
sequence=202.$suffix
rm -rf $input.$sequence
mkdir $input.$sequence
