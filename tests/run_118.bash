...
(
    ...
    mpirun -n 1 -gtool "amplxe-cl -collect hpc-performance -data-limit=0 -result-dir /home/dc-fili1/gandalf/intel/amplxe/projects/gandalf/$input.$sequence.hpc-performance:0" /home/dc-fili1/gandalf/bin/gandalf_measure ../DiRAC/$input.dat &> output
)
